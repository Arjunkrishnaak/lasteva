...
Read [this](https://telegram.dog/Arjunkrishnaak/12) before you start messing up with your edits.
...
* Check [info.py](https://github.com/Arjunkrishnaak/lasteva/blob/master/info.py) for more
